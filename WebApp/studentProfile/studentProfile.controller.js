(function () {
    ...
    StudentProfileController.$inject = ['$location', '$cookieStore', 'FlashService',  '$rootScope', 'CourseService', 'UserService', 'ProfileCourseService' ];
    function StudentProfileController($location, $cookieStore, FlashService, $rootScope, CourseService, UserService, ProfileCourseService) {
        var vm = this;
