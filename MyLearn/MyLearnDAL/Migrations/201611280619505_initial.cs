namespace MyLearnDAL.Migrations
{
    ...
    public partial class initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        IsActive = c.Int(nullable: false),
                        StateDescription = c.String(nullable: false),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.TechnologyStudents", "Technology_TecnologyId", "dbo.Tecnology");
            DropForeignKey("dbo.ProjectTechnologies", "Technology_TecnologyId", "dbo.Tecnology");
            ...
            DropIndex("dbo.TechnologyStudents", new[] { "Technology_TecnologyId" });
            DropIndex("dbo.ProjectTechnologies", new[] { "Technology_TecnologyId" });
